...
public class VentanaInstrucciones extends JDialog {
	...
	public VentanaInstrucciones(JFrame padre) {
		...
		// Tercera pestaña
		instrucciones.addTab("Mecánica", null, getPanel3(), null);
	...
	private JPanel getPanel1() {
		...
		textArea.setText("Consigue los cuatro ticks de cada categoria. Cada vez que aciertes cuatro preguntas, se te otorgará un tick de la categoria de la ultima pregunta. Sé el primero en conseguir los cuatro ticks y gana este divertido juego.");
	...
	private JPanel getPanel2() {
		...
		txtCat2.setText("Geografía.\nEn esta categoría se pondrá aprueba tus conocimientos sobre la geografía mundial.");
	...
	private JPanel getPanel3() {
		...
		mecanica.setText("Tira el dado y escoge la casilla que mas te guste dependiendo del número que te haya salido.\n\n"
				+ "Acierta la pregunta y continua jugando.\nSi fallas, perderás el turno.");
	...
	private JPanel getPanel4() {
		...
		contacto.setText("<html><font color='white'>Para más información, visite nuestra página:</font>\n\n\t<a href=\"http://arquisoft.github.io/Trivial5b\">www.arquisoft.github.io/Trivial5b</a></html>");
